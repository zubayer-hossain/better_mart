...
class Team extends Model
{
    ...
    */
    public function setImageAttribute($value)
    {
        ...
        $destination_path = config('backpack.base.root_disk_base') . '/teams';
...
//            }
    ...
    public function setVcardAttribute($value)
    {
        $attribute_name = "vcard";
        // or use your own disk, defined in config/filesystems.php
        $disk = config('backpack.base.root_disk_name', 'public_uploads');
        // destination path relative to the disk above
        $destination_path = config('backpack.base.root_disk_base') . '/teams/vcard';
