...
/**
 * Class ProductModelCrudController
...
class ProductModelCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('product model', 'product models');
    }
    ...
    public function destroy($id)
    {
        ...
        if (!empty(Product::where('product_model_id', $id)->first())) {
            return response()->json([
                'success' => false,
                'message' => 'Can\'t delete product model. This model is used in products.',
            ]);
        }
